...
```bash
/home/thisen-ekanayake/miniforge3/envs/habitat/bin/python tools/capture_sensors.py \
...
```bash
cd /ml/FORESIGHT
/home/thisen-ekanayake/miniforge3/envs/habitat/bin/python tools/capture_sensors.py --scene 00802-wcojb4TFT35
